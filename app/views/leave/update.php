      ...
      <div class="card-body">
            <?php echo Form::open(null, array('class' => 'form well', 'role' => 'form'));?>
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                   <?php echo Form::textarea('desc', Form::value('desc')?Form::value('desc'):$leave->leav_desc, array('required' => true, 'class' => 'form-control form-control-sm', 'placeholder' => __tr('leav_fp_description')));?>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                   <?php echo Form::input('bdate', Form::value('bdate')?Form::value('bdate'):$leave->leav_bdate, array('required' => true, 'class' => 'form-control form-control-sm', 'placeholder' =>  __tr('leav_fp_start_date')), 'date');?>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                   <?php echo Form::input('edate', Form::value('edate')?Form::value('edate'):$leave->leav_edate, array('required' => true, 'class' => 'form-control form-control-sm', 'placeholder' =>  __tr('leav_fp_end_date')), 'date');?>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                   <?php echo Form::select('wf', $workflows, Form::value('wf')?Form::value('wf'):$leave->wf_id, array('required' => true, 'class' => 'form-control form-control-sm'));?>
