  ...
  <div class="col-md-6">
    <div class="card">
      <div class="card-header bg-white font-weight-bold">
        <?php echo __tr('wf_workflow_role_fle_edit');?>
      </div>
      <div class="card-body">
            <?php echo Form::open(null, array('class' => 'form well', 'role' => 'form'));?>
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                   <?php echo Form::text('name', Form::value('name')?Form::value('name'):$role->wf_role_name, array('class' => 'form-control form-control-sm', 'required' => true, 'placeholder' => __tr('wf_fp_workflow_role_name')));?>
                ...
                <div class="row">
                    <div class="offset-1 col pr-2">
                       ...
                       <?php echo Html::anchor('workflow/detail/' . $role->wf_id,  __tr('wf_txt_cancel'), array('class' => 'btn btn-sm btn-secondary'));?>
                    </div>
                </div> 
              <?php echo Form::close();?>
            </div>
