  ...
  <div class="col-md-6">
    <div class="card">
      <div class="card-header bg-white font-weight-bold">
        <?php echo __tr('wf_workflow_node_path_fle_edit');?>
      </div>
      <div class="card-body">
             <?php echo Form::open(null, array('class' => 'form well', 'role' => 'form'));?>
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <?php echo Form::select('node_from', $lnodes, Form::value('node_from')?Form::value('node_from'):$node_path->wf_node_from_id, array('class' => 'form-control form-control-sm', 'required' => true));?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <?php echo Form::select('node_to', $lnodes, Form::value('node_to')?Form::value('node_to'):$node_path->wf_node_to_id, array('class' => 'form-control form-control-sm', 'required' => true));?>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-md-9">
                       <?php echo Form::text('name', Form::value('name')?Form::value('name'):$node_path->wf_np_name, array('class' => 'form-control form-control-sm', 'placeholder' => __tr('wf_fp_workflow_node_path_name')));?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                       <?php echo Form::select('cond_type', array('' => ' ---- ') + $conditions_types, Form::value('cond_type')?Form::value('cond_type'):$node_path->wf_np_cond_type, array('class' => 'form-control form-control-sm'));?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <?php echo Form::text('cond_name', Form::value('cond_name')?Form::value('cond_name'):$node_path->wf_np_cond_name, array('class' => 'form-control form-control-sm', 'placeholder' => __tr('wf_fp_workflow_node_path_cond_name')));?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                         <?php echo Form::select('cond_operator', array('' => ' ---- ') + $conditions_operator, Form::value('cond_operator')?Form::value('cond_operator'):$node_path->wf_np_cond_operator, array('class' => 'form-control form-control-sm'));?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                         <?php echo Form::select('cond_oc_value', array('' => ' ---- ') + $loutcomes, Form::value('cond_oc_value')?Form::value('cond_oc_value'):$node_path->wf_np_cond_value, array('class' => 'form-control form-control-sm'));?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                         <?php echo Form::text('cond_value', Form::value('cond_value')?Form::value('cond_value'):$node_path->wf_np_cond_value, array('class' => 'form-control form-control-sm', 'placeholder' => __tr('wf_fp_workflow_node_path_cond_value')));?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <?php echo Form::select('is_default', $defaults, Form::value('is_default')?Form::value('is_default'):$node_path->wf_np_is_default, array('required' => true, 'class' => 'form-control form-control-sm'));?>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <?php echo Form::number('order', Form::value('order')?Form::value('order'):$node_path->wf_np_order, array('class' => 'form-control form-control-sm', 'placeholder' => __tr('wf_fp_workflow_node_path_order')));?>
                ...
                <div class="row">
                    <div class="offset-1 col pr-2">
                       ...
                       <?php echo Html::anchor('workflow/detail/' . $node_path->wf_id,  __tr('wf_txt_cancel'), array('class' => 'btn btn-sm btn-secondary'));?>
                    </div>
                </div> 
               <?php echo Form::close();?>
            </div>
