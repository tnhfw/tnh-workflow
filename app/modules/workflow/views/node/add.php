  ...
  <div class="col-md-6">
    <div class="card">
      <div class="card-header bg-white font-weight-bold">
        <?php echo sprintf(__tr('wf_workflow_node_fle_create'), $wf->wf_name );?>
      </div>
      <div class="card-body">
          <?php echo Form::open(null, array('class' => 'form well', 'role' => 'form'));?>
            <div class="form-group row">
                ...
                <div class="col-md-9">
                  <?php echo Form::text('name', Form::value('name'), array('class' => 'form-control form-control-sm', 'required' => true, 'placeholder' => __tr('wf_fp_workflow_node_name')));?>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                  <?php echo Form::select('task_type', $wf_task_types, Form::value('task_type'), array('required' => true, 'class' => 'form-control form-control-sm'));?>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                   <?php echo Form::select('node_type', $wf_node_types, Form::value('node_type'), array('required' => true, 'class' => 'form-control form-control-sm'));?>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                   <?php echo Form::textarea('script', Form::value('script'), array('class' => 'form-control form-control-sm', 'placeholder' => __tr('wf_fp_workflow_node_script'), 'rows' => 10));?>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <?php echo Form::select('service', $lservice, Form::value('service'), array('class' => 'form-control form-control-sm'));?>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <?php echo Form::text('service_arg', Form::value('service_arg'), array('class' => 'form-control form-control-sm', 'placeholder' => __tr('wf_fp_workflow_node_service_arg')));?>
            ...
            <div class="form-group row">
             ...
             <div class="form-group row">
                ...
                <div class="col-md-9">
                    <?php echo Form::select('role', $lroles, Form::value('role'), array('class' => 'form-control form-control-sm'));?>
