  ...
  <div class="col-md-6">
    <div class="card">
      <div class="card-header bg-white font-weight-bold">
        <?php echo __tr('wf_workflow_fle_edit');?>
      </div>
      <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                  <?php echo Form::text('name', Form::value('name')?Form::value('name'):$wf->wf_name, array('required' => true, 'placeholder' => __tr('wf_fp_workflow_name'), 'class' => 'form-control form-control-sm '));?>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                  <?php echo Form::textarea('desc', Form::value('desc')?Form::value('desc'):$wf->wf_desc, array('class' => 'form-control form-control-sm', 'placeholder' =>  __tr('wf_fp_workflow_desc')));?>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                  <?php echo Form::select('status', $wf_status, Form::value('status')?Form::value('status'):$wf->wf_status, array('required' => true, 'class' => 'form-control form-control-sm'));?>
